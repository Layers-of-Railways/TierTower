...
public interface CustomInventoryStorage extends SlottedStorage<ItemVariant> {
    /**
     * Return a wrapper around an {@link UpdateFreeContainer}, allowing more advanced handling logic.
     *
     ...
     */
    static CustomInventoryStorage of(UpdateFreeContainer inventory, @Nullable Direction direction) {
        Objects.requireNonNull(inventory, "Null inventory is not supported.");
        return CustomInventoryStorageImpl.of(inventory, direction);
    }
