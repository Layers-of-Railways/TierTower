...
package io.github.slimeistdev.tier_tower.mixin;

import io.github.slimeistdev.tier_tower.utils.ConditionalMixinManager;
...
public class TierTowerMixinPlugin implements IMixinConfigPlugin {
    public static final Logger LOGGER = LoggerFactory.getLogger("TierTower/MixinPlugin");
